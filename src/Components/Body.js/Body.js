  ...
  return (
    <div>
      <div className="flex justify-left mt-40 fonthello">
        <div>
          <h1 className=" my-2">Hi! my name is </h1>
          <div className="name  text-transparent bg-clip-text bg-gradient-to-b from-[#bababa] to-[#ffffff] dark:text-[#32abb4]  text-4xl leading-4 transition duration-[1500ms] ">
            <Typewriter
              options={{
                cursor: "_",
                delay: 140,
          ...
          <p className="my-2">I am a Front-End Developer</p>
        </div>
      </div>
      ...
      <div data-aos="slide-right">
        ...
        <div className="text-sm  md:text-lg text-light my-5 md:pl-52 ">
      ...
      <div data-aos="slide-right">
        ...
        <div className="grid grid-cols-2 md:grid-cols-3 md:pl-52 mt-5">
