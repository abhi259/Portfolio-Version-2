      ...
      <div data-aos="fade-right">
        <div className=" group  transition duration-700  ">
          <div className=" md:w-[500px] relative ">
            <div className="md:group-hover:-translate-x-14   md:dark:bg-[#05222a] bg-[#373737]  group-hover:bg-opacity-0  transition duration-700 ">
              <img
            ...
            <div className=" absolute top-14 right-0 md:-right-52  md:w-[400px]   h-48  flex flex-col justify-around  bg-[#929292]/60 dark:bg-[#001C23]/60 backdrop-blur-xl  p-5 md:group-hover:translate-x-20 transition duration-700 ">
              <div>
